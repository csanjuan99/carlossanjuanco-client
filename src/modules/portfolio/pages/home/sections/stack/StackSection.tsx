          ...
          <div className="flex flex-wrap gap-5">
            {group.items.map((item) => (
              <motion.div
                ...
                // The resting shadow lives in a class, not `style`: an inline box-shadow
                // outranks any hover rule, which silently disabled this hover state.
                className="relative flex h-[118px] w-[118px] items-center justify-center overflow-hidden rounded-full shadow-[inset_0_0_0_1px_rgba(212,175,106,.9),inset_0_0_0_5px_rgba(232,223,208,.9),inset_0_0_0_6px_rgba(143,74,46,.35),0_10px_20px_-12px_rgba(43,38,34,.45)] transition-shadow duration-500 hover:shadow-[inset_0_0_0_1px_#d4af6a,inset_0_0_0_5px_rgba(232,223,208,.9),inset_0_0_0_6px_rgba(143,74,46,.5),0_14px_28px_-10px_rgba(43,38,34,.55),0_0_30px_rgba(212,175,106,.5)]"
                style={{ background: 'radial-gradient(circle at 38% 32%, #f0e8d8, #e2d5ba 55%, #cbb287)' }}
              >
